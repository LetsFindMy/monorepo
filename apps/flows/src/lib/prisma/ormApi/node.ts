 ...
 *
 * This function attempts to update an existing node if it exists or create a new one if it does not. It checks for the existence of a flow before proceeding with the upsert operation.
 *
